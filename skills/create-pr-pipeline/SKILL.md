...
Read the reference doc at `references/create-pr-pipeline.md` (relative to this skill) for the full procedure. Follow the steps below using that doc as your guide.
